/*
 * MModuleLoaderMeasurementsHDFGRIPS.h
 *
...
#ifndef __MModuleLoaderMeasurementsHDFGRIPS__
#define __MModuleLoaderMeasurementsHDFGRIPS__
...
class MModuleLoaderMeasurementsHDFGRIPS : public MModuleLoaderMeasurements
{
  // public interface:
 public:
  //! Default constructor
  ...
  //! Default destructor
  virtual ~MModuleLoaderMeasurementsHDFGRIPS();
  
  //! Create a new object of this class 
  virtual MModuleLoaderMeasurementsHDFGRIPS* Clone() { return new MModuleLoaderMeasurementsHDFGRIPS(); }
...
#ifdef ___CLING___
 public:
  ClassDef(MModuleLoaderMeasurementsHDFGRIPS, 0) // no description
#endif
