/*
 * MModuleLoaderMeasurementsHDFGRIPS.cxx
 *
 *
...
////////////////////////////////////////////////////////////////////////////////
//
// MModuleLoaderMeasurementsHDFGRIPS
//
////////////////////////////////////////////////////////////////////////////////
...
#ifdef ___CLING___
ClassImp(MModuleLoaderMeasurementsHDFGRIPS)
#endif
...
MModuleLoaderMeasurementsHDFGRIPS::MModuleLoaderMeasurementsHDFGRIPS() : MModuleLoaderMeasurements()
{
  // Construct an instance of MModuleLoaderMeasurementsHDFGRIPS
  
  // Set all module relevant information
  
  // Set the module name --- has to be unique
  m_Name = "Measurement loader for HDF files (GRIPS)";
  
  // Set the XML tag --- has to be unique --- no spaces allowed
  m_XmlTag = "XmlTagMeasurementLoaderHDFGRIPS";
...
MModuleLoaderMeasurementsHDFGRIPS::~MModuleLoaderMeasurementsHDFGRIPS()
{
  // Delete this instance of MModuleLoaderMeasurementsHDFGRIPS
}
...
bool MModuleLoaderMeasurementsHDFGRIPS::Initialize()
{
...
bool MModuleLoaderMeasurementsHDFGRIPS::OpenHDF5File(MString FileName)
{
...
bool MModuleLoaderMeasurementsHDFGRIPS::ReadBatchHits()
{
  try { // HDF5 throws exceptions, thus need to encapsulate everything in try..catch
...
bool MModuleLoaderMeasurementsHDFGRIPS::AnalyzeEvent(MReadOutAssembly* Event)
{
...
void MModuleLoaderMeasurementsHDFGRIPS::Finalize()
{
  // Initialize the module 
  
  MModule::Finalize();
  
  cout<<"MModuleLoaderMeasurementsHDFGRIPS: "<<endl;
...
bool MModuleLoaderMeasurementsHDFGRIPS::ReadXmlConfiguration(MXmlNode* Node)
{
...
MXmlNode* MModuleLoaderMeasurementsHDFGRIPS::CreateXmlConfiguration()
{
...
void MModuleLoaderMeasurementsHDFGRIPS::ShowOptionsGUI()
{
  //! Show the options GUI

  MGUIOptionsLoaderMeasurementsHDFGRIPS* Options = new MGUIOptionsLoaderMeasurementsHDFGRIPS(this);
  Options->Create();
  gClient->WaitForUnmap(Options);
}


// MModuleLoaderMeasurementsHDFGRIPS.cxx: the end...
////////////////////////////////////////////////////////////////////////////////
